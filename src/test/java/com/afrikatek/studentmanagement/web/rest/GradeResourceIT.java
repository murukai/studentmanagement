...
class GradeResourceIT {
    ...
    public static Grade createEntity(EntityManager em) {
        Grade grade = new Grade().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION);
        return grade;
    }
    ...
    public static Grade createUpdatedEntity(EntityManager em) {
        Grade grade = new Grade().name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
        return grade;
    }
    ...
    void putExistingGrade() throws Exception {
        ...
        updatedGrade.name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateGradeWithPatch() throws Exception {
        ...
        partialUpdatedGrade.name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
